...
#Fazer uma função que recebe várias listas
#Criar uma lista vazia para receber apenas os produtos
#Percorrer cada lista
#Fazer o unpacking das tuplas
#Fazer o append do produto na lista
#Usar o set para que não haja repetições
#Usar o list para transformar em lista de novo
#Fazer um return

def produtos(*listas):
	lista_com_produtos = []
	for lista in listas:
		for produto, qtd in lista:
			lista_com_produtos.append(produto)
	lista_com_produtos = set(lista_com_produtos)
	lista_com_produtos = list(lista_com_produtos)
	return lista_com_produtos
...
print(f'Lista de produtos: {produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)}')
print(len(produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)))